    ...
    if (status === "approved") {
      try {
        ...
        if (!existingCompany) {
          ...
          const updatedCompany = await Company.findByIdAndUpdate(existingCompany._id, companyData, { new: true });
        ...
        console.log("🔍 Verification - Company after approval:", verifyCompany ? {
